// Scientific (Latin) names for every species in the IOC World Bird List v15.2,
// keyed by the exact English name used in `birdNames.ts`. Generated from the
// IOC master file (IOC_Names_File_Plus-15.2_red.xlsx). Do not hand-edit; to
// refresh, re-extract from the next IOC release. `Domesticated Chicken` is the
// one non-IOC entry we carry (Gallus gallus domesticus).
//
// Use `latinFor(name)` at render time (Dex cards, future feed cards). It maps
// the custom easter-egg species Kelsey to "Felis catus" and returns "" for any
// name without a binomial (e.g. Mystery Bird), so callers can skip the line.

import { isCustomSpecies } from './customSpecies';

export const BIRD_LATIN: Record<string, string> = {
  ...
  "Banded Yellow Robin": "Eopsaltria placens",
  ...
  "Black-banded Crake": "Rufirallus fasciatus",
  ...
  "Black-chinned Robin": "Leucophantes brachyurus",
  ...
  "Black-fronted Fig Parrot": "Nannopsittacus nigrifrons",
  ...
  "Cloven-feathered Dove": "Ptilinopus holosericea",
  ...
  "Dwarf Sparrowhawk": "Tachyspiza nanus",
  ...
  "Grande Comore Drongo": "Dicrurus fuscipennis",
  ...
  "Grey-flanked Thrush": "Turdus phaeopygus",
  ...
  "Grey-headed Bulbul": "Microtarsus priocephalus",
  ...
  "Hispaniolan Elaenia": "Elaenia cherrei",
  ...
  "Large Fig Parrot": "Cyclopsitta desmarestii",
  ...
  "Madagascar Plover": "Anarhynchus thoracicus",
  ...
  "Matinan Blue Flycatcher": "Eumyias sanfordi",
  ...
  "Oberholser's Fruit Dove": "Ramphiculus gularis",
  ...
  "Olive-backed Flowerpecker": "Pachyglossa olivacea",
  ...
  "Rufous-faced Crake": "Rufirallus xenopterus",
  ...
  "Salvadoran Flycatcher": "Myiarchus flavidior",
  "Salvadori's Antwren": "Myrmotherula minor",
  "Salvadori's Fig Parrot": "Cyclopsitta salvadorii",
  ...
  "Sangihe Cicadabird": "Edolisoma salvadorii",
  ...
  "Sooty Flycatcher": "Artomyias fuliginosa",
  ...
  "Vanikoro Whistler": "Pachycephala vanikorensis",
  ...
  "White-spotted Mannikin": "Mayrimunia leucosticta",
  ...
  "White-throated Fiji Whistler": "Pachycephala vitiensis",
  ...
  "Yellow-throated Fiji Whistler": "Pachycephala graeffii",
  ...
  "Yellow-whiskered Chlorospingus": "Chlorospingus parvirostris",
...
export function latinFor(name: string): string {
  const n = name.trim();
  if (isCustomSpecies(n)) return n.toLowerCase() === 'kelsey' ? 'Felis catus' : '';
  return BIRD_LATIN[n] ?? '';
}
