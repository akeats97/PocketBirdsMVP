...
- **Wishlist cross-off celebration (approved Jun 11 2026, unbuilt).** When a sighting is logged for a species on the user's wishlist, fire a small moment (toast or a line in the new-species celebration, e.g. "one off the wishlist"). Do NOT auto-unstar; Alex explicitly wants the star to stay.
